...
logging.basicConfig(format='%(asctime)s %(levelname)s:%(message)s', datefmt='%m/%d/%Y %I:%M:%S %p', filename=f'api-week-{datetime.datetime.now().strftime("%V")}.log', level=logging.INFO)
