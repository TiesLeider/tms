...
def multiprocessing(aantal):
    print(f"==========Start. aantal={aantal*100000}.==========")
    ...
    with open("db_test.txt", "a+") as outfile:
        outfile.write(f"==========Klaar. aantal regels={aantal*100000} Opdracht duurde {(verschil.microseconds / 1000) / 100000}.==========\n")
    print(f"==========Klaar. aantal regels={aantal*100000} Opdracht duurde {(verschil.microseconds / 1000) / 100000}.==========")
