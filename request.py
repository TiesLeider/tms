...
data2 = b'{"ojson":{"assetnummer":"w2953","storing":8,"druk_b1":0,"druk_b2":0,"druk_a1":760,"druk_a2":0,"omloop_a":1,"omloop_b":0,"kracht_a":0,"kracht_b":0}}'
...
# r = requests.post(url= "http://127.0.0.1:8000/tram/error", data=data)
# print(r.json())
